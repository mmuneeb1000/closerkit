...
export default function EmptyPitches() {
  return (
    <div className="rounded-xl bg-white px-8 py-16 text-center shadow-sm">
      ...
      <h2 className="mt-6 text-2xl font-semibold">No Proposals Yet</h2>

      <p className="mx-auto mt-3 max-w-md text-muted">
        Generate your first AI-powered website proposal to start building your
        proposal history.
      </p>
    </div>
  );
